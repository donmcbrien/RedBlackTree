...
extension RedBlackTreeKeyProtocol {
   /// Default implementation. Duplicate entries should be ignored when inserting
   /// records in the tree.
...
extension RedBlackTree {
   ...
   /// the next which would be deleted).
   ///
   ...
   /// the order in which deletion will occur).
   ///
...
extension RedBlackTree {
   ...
   /// Returns `true` if the tree is empty. Tree is unchanged.
   ...
   /// Counts records in a `RedBlackTree`. Returns the number of records in the tree.
   /// Tree is unchanged.
...
extension RedBlackTree {
   ...
   /// implicit sort key. Elements which encounter duplicate keys using this
   /// operator will be excluded from the tree and returned in an array
   /// if the `duplicates` flag in the `RedBlackTreeOrderingProtocol`
   /// is set to `.refused` (its default value). When permitted, duplicates
   /// are added to the tree in the order in which they were included
   /// in the input array.
   ///
   ...
   ///   already in the tree and the `duplicates` flag was set to `.refused`.
   ...
   /// the `duplicates` flag in the `RedBlackTreeOrderingProtocol`
   /// is set to `.refused`. When permitted, duplicates are sorted in the
   /// order in which they were added to the tree.
   ///
